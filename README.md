This repository was created for a school work, it uses HTML for markup, CSS for style sheets, Javascript for redirects, pass variables using URL and make a better interation with user.
